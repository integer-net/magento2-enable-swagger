...
## Report bugs using Github's [issues](https://github.com/integer-net/magento2-enable-swagger/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/integer-net/magento2-enable-swagger/issues/new); it's that easy!
